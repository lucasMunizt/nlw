...
export function NewNoteCard() {
  ...
  return (
    <Dialog.Root>
      ...
      <Dialog.Trigger className="rounded-md flex flex-col bg-slate-700 g-3 p-5 text-left outline-none hover:ring-2 hover:ring-slate-600 focus-visible:ring-2 focus-visible:ring-lime-400">
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed left-1/2 overflow-hidden top-1/2 -translate-x-1/2 -translate-y-1/2 max-w-[640px] w-full h-[60vh] bg-slate-700 rounded-md flex flex-col outline-none">
          ...
          <form onSubmit={handleSaveNote} className="flex-1 flex flex-col">
            ...
            <button
              type="submit"
              className="w-full bg-lime-400 py-4 content-center text-sm text-lime-950 outline-none font-medium hover:bg-lime-500">
              Salvar notas
            </button>
          </form>
        </Dialog.Content>
